...
echo "source ../result/e_mysql_to_doris.sql;" |mysql -h$master_host -P$master_port -uroot -p$doris_password 2>error.log
...
#table charges to drop old table and create new table
                ...
                echo "source ../result/new_e_mysql_to_doris.sql;" |mysql -h$master_host -P$master_port -uroot -p$doris_password 2>error.log
